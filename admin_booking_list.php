...
$stat_total = (int)$st_row['t']; $stat_pending = (int)$st_row['p'];
$stat_approved = (int)$st_row['a']; $stat_cancelled = (int)$st_row['c'];
...
.bk-banner-booking { background: linear-gradient(135deg, var(--ink) 0%, #2a2a4a 100%); }
...
<div class="bk-wrap">
  ...
  <div class="bk-banner bk-banner-booking">
    <div class="bk-banner-text">
      <h1>ข้อมูลการเข้าพัก</h1>
      <p>รายการที่รออนุมัติและยกเลิก — ตรวจสอบและจัดการได้จากหน้านี้</p>
    </div>
              ...
              <tr>
                ...
                <td>
                  <div class="bk-actions">
                    <?php if (['booking_status'] !== 'approved'): ?>
                      <form method="POST" class="bk-inline" onsubmit="return confirm('ยืนยันอนุมัติรายการนี้?')">
                        ...
                        <button class="bk-btn bk-btn-approve" style="font-size:0.75rem;padding:7px 12px;">✓ อนุมัติ</button>
                      </form>
                    <?php endif; ?>
                    <form method="POST" class="bk-inline" onsubmit="return confirm('จัดเก็บรายการนี้?')">
                      ...
                      <input type="hidden" name="id" value="<?= (int)['id'] ?>">
                      <button class="bk-btn bk-btn-warning" style="font-size:0.75rem;padding:7px 12px;">📦 จัดเก็บ</button>
                    </form>
          ...
          <?php else: ?>
            <tr><td colspan="9">
              <div class="bk-empty">
                ...
                <div class="bk-empty-text">ไม่พบรายการที่ต้องจัดการ<br><?=  ? 'ลองเปลี่ยนคำค้นหา' : 'รายการทั้งหมดได้รับการจัดการแล้ว' ?></div>
              </div>
            </td></tr>
          <?php endif; ?>
        </tbody>
